...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a192f]">
      ...
      {/* Main Content */}
      <main className="md:ml-64 min-h-screen bg-[#0a192f] p-0">
          ...
          >
            <div>
              ...
              <div className="bg-[#112240] rounded-lg p-4 md:p-8">
                ...
                <p className="text-blue-400 mb-4">
                  DIT University, Dehradun | 2018 - 2022
                </p>
                <p className="text-gray-400 text-sm md:text-base">
                  Focused on core computer science concepts, data structures,
                  algorithms, and software engineering principles. Participated
                  in various coding competitions and technical workshops.
                </p>
              </div>
            </div>
          </section>
